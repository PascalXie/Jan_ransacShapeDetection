...
if __name__=='__main__':
	...
	path = '../step8-planeDetectWithHough/step2-planeDetection/build-planeDetection-Desktop_Qt_5_14_2_GCC_64bit-Debug/'
	...
	# save figure
	plt.savefig('figure_step8_shapeDetection.png')
